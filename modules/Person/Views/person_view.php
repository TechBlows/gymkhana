...
<html>
    ...
    <title>GYMKHANA &mdash; Person Information </title>
...
<?php $this->load->view('admin/admin.php');?>
    <div class="container">
        <h3 style="font-size:20pt">Gymkhana&mdash; Members Information</h3>

        <br />
        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Add Members</button>
        <button class="btn btn-default" onclick="reload_table()"><i class="glyphicon glyphicon-refresh"></i> Reload Members</button>
        <br />
        <br />
