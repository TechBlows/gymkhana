<?php
	Class Login extends MX_Controller {
		...
		public function new_user_registration() {
			...
			$this->form_validation->set_rules('username', 'Username', 'trim|required|is_unique[user_login.user_name]');
			$this->form_validation->set_rules('email_value', 'Email', 'trim|required|is_unique[user_login.user_email]');
			$this->form_validation->set_rules('password', 'Password', 'trim|required');
			$this->form_validation->set_rules('passconf', 'Password Conformation', 'trim|required|matches[password]');
